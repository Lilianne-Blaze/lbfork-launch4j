...
public abstract class JreForm extends JPanel {
    ...
    /**
     * Adds fill components to empty cells in the first row and first column of the grid. This ensures that the grid
     * spacing will be the same as shown in the designer.
     * 
     * @param cols
     *            an array of column indices in the first row where fill components should be added.
     * @param rows
     *            an array of row indices in the first column where fill components should be added.
     */
     ...
     * 
     * @param imageName
     *            the package and name of the file to load relative to the CLASSPATH
     * 
    ...
    public JPanel createPanel() {
        ...
        jpanel1.add(_jvmOptionsTextLabel,
                new CellConstraints(2, 16, 1, 1, CellConstraints.DEFAULT, CellConstraints.TOP));
